<div>
    <button
        class="bg-[#5354FB] text-white font-bold tracking-wide uppercase px-8 py-3 rounded-[4px] hover:bg-[#1F20A6] transition duration-300 ease-in-out"
            ...
            <div class="flex gap-4">
                ...
                {{-- {{ --('Hours')}} --}}
                    ...
                    <div class="flex" x-data="{ hours: @entangle('hours') }">
                        ...
                        <button type="button" class="bg-[#1E1E2C] hover:bg-[#313145] transition duration-300 ease-in-out text-[#C3C3D1]
                            py-2 px-3 text-3xl" @click="hours++">+</button>
                    </div>
